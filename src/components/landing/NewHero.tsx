...
export default function NewHero({ onGetDNA }: NewHeroProps) {
  ...
  return (
    <div className="relative w-full min-h-[calc(100vh-48px)] overflow-hidden flex flex-col lg:flex-row items-center justify-center py-12 sm:py-20 px-4 sm:px-6 pt-28 sm:pt-32 bg-[#FAFBFF]">
