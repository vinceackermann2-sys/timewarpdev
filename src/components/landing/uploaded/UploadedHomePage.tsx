      ...
      >
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          <button
            ...
            className="bg-white text-gray-800 px-6 py-3 rounded-full font-semibold flex items-center gap-3 hover:bg-gray-50 transition-colors shadow-md border border-gray-200 disabled:opacity-60"
          >
