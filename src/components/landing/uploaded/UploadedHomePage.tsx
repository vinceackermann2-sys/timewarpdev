...
import { IntegrationIcons } from './components/DataIcons';
...
const FooterCTA = () => (
  <section className="relative pt-32 pb-48 px-4 flex flex-col items-center justify-center text-center overflow-hidden">
    ...
    <div className="flex flex-col sm:flex-row gap-4 mb-4 relative z-10">
      ...
      <button className="bg-black/80 backdrop-blur-md text-white px-6 py-3 rounded-full font-semibold flex items-center gap-2 hover:bg-black/90 transition-colors shadow-lg">
    ...
    <p className="text-xs text-gray-500">By continuing, you agree to our <a href="#" className="underline">Terms of Service</a> and <a href="#" className="underline">Privacy Policy</a>.</p>
  </section>
);
