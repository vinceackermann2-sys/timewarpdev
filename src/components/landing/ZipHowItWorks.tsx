...
const PhoneMockup = ({ activeStep }: { activeStep: number }) => (
  <div className="relative mx-auto w-[280px] h-[580px] sm:w-[320px] sm:h-[650px] bg-card rounded-[3rem] border-[8px] border-foreground shadow-2xl overflow-hidden flex-shrink-0">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="max-w-xl">
            <h3 className="text-4xl md:text-5xl lg:text-6xl font-medium text-foreground mb-6 tracking-tight" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
