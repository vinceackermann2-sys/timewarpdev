    ...
    <section className="orb-hero">
      ...
      <style>{`
        ...
        @media (max-width: 640px) {
          ...
          .orb-hero__content { position: fixed; width: clamp(320px, 96vw, 500px); top: 50%; left: 50%; transform: translate(-50%, -50%); animation: orb-fade-up-mobile 0.8s ease-out both; }
