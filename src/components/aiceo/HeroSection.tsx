    ...
    <section className="relative min-h-screen w-full overflow-hidden flex flex-col items-center justify-start">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(180deg, #05070f 0%, #0a0f1e 30%, #0d1528 60%, #111d3a 100%)",
          }}
        />
        ...
        <div
          ...
          style={{
            ...
            left: "20%",
            background:
              "radial-gradient(ellipse at center, rgba(168, 130, 255, 0.08) 0%, transparent 70%)",
            filter: "blur(40px)",
          }}
        />
        <div
      ...
      <div className="relative z-10 w-full max-w-4xl mx-auto px-4 pt-16 pb-10 flex flex-col items-center text-center">
        {/* Headline */}
        <h1
          className="leading-[1.05] tracking-tight mb-5"
          style={{
