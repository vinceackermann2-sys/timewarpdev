...
export function DashCardDetailPanel({ card, open, onClose, onExecuteAction }: Props) {
  ...
  return (
    <aside className="w-[420px] shrink-0 h-[calc(100%-1.5rem)] my-3 mr-3 flex flex-col rounded-2xl border border-border overflow-hidden bg-[#fcfcfd] shadow-[0_0_18px_2px_hsl(210_20%_85%/0.9)]">
