...
import { ChevronRight, ExternalLink, ListTodo, Monitor, Paperclip, Plus, ScrollText } from "lucide-react";
...
type Props = {
  ...
  /** Open the Skills dialog (preset + custom skills). */
  onOpenSkills?: () => void;
  ...
  if (isMobile) {
    return (
      <>
        ...
        >
          <div className="flex items-center gap-3">
            <ListTodo className={cn("w-4 h-4", isPlanMode ? "text-primary" : "text-muted-foreground")} />
            Planning
          </div>
