    ...
    <div className="flex-1 min-full px-4 md:px-6 py-6 space-y-5 max-w-3xl mx-auto w-full">
      {messages.map((msg, msgIndex) => {
        ...
        return (
          <div
            key={msg.id}
            className={`flex flex-col ${msg.role === "user" ? "items-end" : "items-start"} animate-in fade-in zoom-in-[0.98] slide-in-from-bottom-4 duration-500 ease-out`}
          >
            <div
              className={cn(
            ...
            >
              {msg.role === "assistant" ? (
                <div className="max-w-none text-foreground text-[15px] leading-[1.8] tracking-[-0.01em]">
