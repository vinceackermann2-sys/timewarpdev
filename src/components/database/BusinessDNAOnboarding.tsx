...
export function BusinessDNAOnboarding({
  ...
  // ── RENDER ───────────────────────────────────────────────
  return (
    <div className="min-h-screen flex flex-col items-center justify-center py-6 sm:py-12 px-3 sm:px-4 font-sans overflow-y-auto bg-[#FAFBFF]">
      <AnimatePresence mode="wait">
        ...
        {step === 0 && !showMethodPicker && (
          ...
          >
            ...
            <div className="w-full max-w-[720px]">
              <div className="border-[1.5px] border-[#4a86ff] rounded-2xl p-2 shadow-sm bg-[#E8F0FE]">
        ...
        {step === 1 && (
          ...
          >
            ...
            <div className="w-full max-w-[720px] rounded-2xl p-6 shadow-sm border border-black/5 bg-[#E8F0FE]">
        ...
        {step === 2 && (
          ...
          >
            ...
            <div className="w-full max-w-[900px] border-[1.5px] border-[#4a86ff] rounded-2xl p-2 shadow-sm mb-6 sm:mb-8 flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-2 bg-[#E8F0FE]">
            ...
            {productSelectTab === "otherUrl" && (
              <div className="w-full max-w-[900px] mb-6 rounded-2xl border border-[#4a86ff]/30 bg-[#E8F0FE] p-4">
                ...
                {extractedProducts.slice(0, 10).map((p: any, i: number) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="p-3 sm:p-5 bg-[#E8F0FE]">
        ...
        {(step === 4 || step === 5) && (() => {
          ...
          >
            ...
            <div className="w-full rounded-2xl p-4 sm:p-6 mb-6 shadow-sm bg-[#E8F0FE]">
            ...
            <div className="w-full flex flex-col">
              ...
              {forgingTab === "found" ? (
                <div className="w-full flex flex-col gap-3">
                  {/* Brand card */}
                  <div className="w-full rounded-xl p-4 bg-[#E8F0FE]">
                  ...
                  {displayProducts.map((p: any, i: number) => (
                    <div key={i} className="w-full rounded-xl p-4 flex items-center gap-3 bg-[#E8F0FE]">
                  ...
                  {audiencesRaw.filter((a: any) => a?.name).map((a: any, i: number) => (
                    <div key={`aud-${i}`} className="w-full rounded-xl p-4 flex items-center gap-3 bg-[#E8F0FE]">
                ...
                {sourcesOpen && (
                  <div className="mt-2 flex flex-col gap-1.5">
                    {urls.map((url, i) => {
                      ...
                      return (
                      <div key={i} className="flex items-center gap-2 text-[13px] text-[#697386] py-1 px-2 rounded-lg bg-[#E8F0FE]">
