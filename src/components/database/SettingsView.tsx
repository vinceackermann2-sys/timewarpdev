  ...
  return (
    <div className="space-y-6 pt-5">
      ...
      <div className="space-y-3">
        {/* Integrity */}
        <div className="flex items-center justify-between rounded-lg border border-border/50 px-4 py-3 bg-background">
        ...
        <button
          ...
          className="w-full flex items-center justify-between rounded-lg border border-border/50 px-4 py-3 transition-colors text-left bg-background"
        >
          <div className="flex items-center gap-3">
            <div className="h-9 w-9 rounded-lg flex items-center justify-center">
