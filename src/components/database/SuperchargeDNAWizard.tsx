  ...
  if (embedded) {
    return (
      <div className="flex flex-col h-full w-full">
        {/* Top progress bar */}
        <div className="shrink-0 backdrop-blur border-b border-border bg-[#F8F7FF]">
        ...
        <div className="shrink-0 backdrop-blur border-t border-border bg-[#F8F7FF]">
          <div className="max-w-5xl mx-auto w-full px-6 py-3 flex items-center gap-3 bg-[#F8F7FF]">
            {FooterActions}
          </div>
        </div>
      </div>
