  ...
  return (
    <div className="flex flex-col h-full overflow-y-auto bg-[#F8F7FF]">
      ...
      <div className="w-full max-w-5xl mx-auto px-4 sm:px-6 pt-10 pb-6">
        ...
        {/* Tabs */}
        <div className="inline-flex items-center p-1 rounded-lg border border-border mb-4 bg-[#ECEAF8]">
          <button
        ...
        <div className="flex items-center justify-between gap-4">
          <div className="relative flex-1 max-w-sm">
            ...
            <Input
              ...
              className="pl-9 h-9 bg-[#ECEAF8]/0"
            />
          </div>
      ...
      {/* Content */}
      <div className="w-full max-w-5xl mx-auto px-4 sm:px-6 flex-1 bg-[#F8F7FF]">
