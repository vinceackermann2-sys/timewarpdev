...
import { FileText, BarChart3, PieChart, Table2, Presentation, TrendingUp, TrendingDown, Minus } from "lucide-react";
  ...
  return (
    <div className="my-4 rounded-xl border border-border/50 bg-card overflow-hidden shadow-sm">
      <div className="bg-[#3399ff]/10 border-b border-[#3399ff]/20 px-5 py-3 flex items-center gap-2">
        ...
        {config.date && <span className="ml-auto text-xs text-muted-foreground">{config.date}</span>}
      </div>
