      ...
      <div style={{ maxWidth: 960, width: "100%", position: "relative", zIndex: 1 }}>
        ...
        <Section>
          ...
          <div style={{ textAlign: "center", margin: "8px 0 0" }}>
            <P>With that said we can't do this for <B>everyone...</B></P>
            <P>If you think you could benefit from this & we think you're the <B>type of company</B> we want to work with.</P>
            <P style={{ marginBottom: 20 }}>Apply below <B>100% free</B> and <B>no credit card</B> 👇</P>
            <ApplyButton onClick={() => setShowForm(true)} isMobile={isMobile} />
          </div>
        </Section>
