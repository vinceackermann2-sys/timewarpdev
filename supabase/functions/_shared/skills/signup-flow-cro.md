...
trigger: signup flow, registration flow, sign up conversion, trial activation, free trial, signup optimisation
---
...
```
[SUGGEST:What signup work do you need?::🔍 Audit current flow|✂️ Reduce friction|🔗 Social auth strategy|📊 Identify drop-off]
```
