...
trigger: popup, exit intent, popover, modal, popup CRO, lead capture popup, popup strategy
---
...
```
[SUGGEST:What popup do you need?::📧 Email capture|🎁 Lead magnet delivery|🚪 Exit intent|💬 Announcement]
```
