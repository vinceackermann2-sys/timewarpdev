...
trigger: copy editing, proofread, edit my copy, fix my writing, review this text, improve this copy, editing
---
...
Key pillars for this skill: **Brand, Audience**
...
For the full refresh checklist, refresh vs. rewrite decision matrix, and cadence guide: 
...
```
[SUGGEST:What copy should I review?::🔍 Run all 7 sweeps|✂️ Clarity sweep only|🎯 CTA & conversion check|🎨 Voice & tone audit]
```
