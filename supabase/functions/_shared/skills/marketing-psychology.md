...
trigger: marketing psychology, persuasion, cognitive bias, mental model, behavioural economics, psychological triggers
---
...
```
[SUGGEST:Which models apply to your situation?::🧠 Explain a principle|🎯 Apply to a campaign|🔍 Diagnose low conversion|📋 Build a persuasion audit]
```
