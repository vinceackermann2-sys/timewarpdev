---
name: Page Conversion Rate Optimization (CRO)
pillars: Product, Audience, Brand, Growth
surface: assistant-chat
trigger: page CRO, conversion rate optimisation, improve conversion, landing page optimisation, CRO audit
---
...
Key pillars for this skill: **Product, Audience, Brand, Growth**
...
Form optimization
Navigation and UX
For comprehensive experiment ideas by page type: 
...
```
[SUGGEST:What page should I audit?::🔍 Full CRO analysis|📝 Improve headline|📣 Optimize CTAs|🛡️ Add trust signals]
```
