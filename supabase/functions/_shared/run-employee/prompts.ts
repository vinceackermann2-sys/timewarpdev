...
**Task status:** When you fully finished the user's ask this turn, end with **Task complete** — one short sentence. If not done, end with **Still in progress:** what remains.
