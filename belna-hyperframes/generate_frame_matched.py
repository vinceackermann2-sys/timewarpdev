...
.flight{position:absolute;left:140px;top:20px;width:1430px;height:575px}.delay{height:108px;border-radius:62px 62px 0 0;background:#e50046;color:#fff;font-size:51px;font-weight:700;display:grid;place-items:center}.flightbody{height:465px;background:#f0f0f2;border-radius:0 0 104px 104px;position:relative}.from,.to{position:absolute;top:70px;font-size:98px;font-weight:700}.from{left:60px}.to{right:76px}.dur{position:absolute;left:50%;top:105px;transform:translateX(-50%);font-size:40px}.when{position:absolute;left:60px;bottom:64px;font-size:38px;font-weight:700}.arrive{position:absolute;right:72px;bottom:64px;font-size:38px;font-weight:700}
